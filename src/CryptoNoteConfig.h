...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x42ca;
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(50000000000001);
...
const char     CRYPTONOTE_BLOCKS_FILENAME[]                  = "shc_blocks.dat";
const char     CRYPTONOTE_BLOCKINDEXES_FILENAME[]            = "shc_blockindexes.dat";
const char     CRYPTONOTE_BLOCKSCACHE_FILENAME[]             = "shc_blockscache.dat";
const char     CRYPTONOTE_POOLDATA_FILENAME[]                = "shc_poolstate.bin";
const char     P2P_NET_DATA_FILENAME[]                       = "shc_p2pstate.bin";
const char     CRYPTONOTE_BLOCKCHAIN_INDICES_FILENAME[]      = "shc_blockchainindices.dat";
const char     MINER_CONFIG_FILE_NAME[]                      = "shc_miner_conf.json";
} // parameters
...
const std::initializer_list<const char*> SEED_NODES = {
  ...
  "121.73.12.60:51487" // Legacy Support Node, Source Build for Ubuntu 14.04 LTS
};
